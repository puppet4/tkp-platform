...
def test_test_env_scripts_must_apply_sql_init():
    ...
    assert "init_all.sql" in up_content, "test_env_up.sh must apply init_all.sql"
    assert "init_all.sql" in reset_content, "test_env_reset_db.sh must apply init_all.sql"

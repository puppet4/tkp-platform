...
from tkp_rag.services.vector_retrieval import create_retriever
from tkp_rag.services.llm_generator import create_generator

logger = logging.getLogger("tkp_rag.retrieval_improved")
...
def _get_embedding_service():
    ...
    if _embedding_service is None:
        from tkp_rag.services.embeddings import create_embedding_service
